...
import { DeleteIcon, AddIcon, CheckIcon, RepeatIcon } from '@chakra-ui/icons';
      ...
      <VStack spacing={6} align="stretch">
        <VStack align="stretch" spacing={4}>
          <HStack justify="space-between">
            <Text fontWeight="bold">Firebase Service Accounts</Text>
                  ...
                  <HStack justify="space-between">
                    <VStack align="start" spacing={1}>
                      <HStack>
                        ...
                        {account.active && <Badge colorScheme="green">Active</Badge>}
                      </HStack>
        ...
        <VStack align="stretch" spacing={4}>
          <Text fontWeight="bold">Google Analytics Settings</Text>
          <FormControl>
            ...
            <Text fontSize="sm" color="gray.500" mt={1}>
              Your GA4 Measurement ID starts with 'G-' and can be found in your Google Analytics
              property settings
            </Text>
          </FormControl>
        </VStack>
