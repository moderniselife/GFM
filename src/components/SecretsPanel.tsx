      ...
      if (matches) {
        ...
        return (
          <VStack align="stretch" spacing={1}>
            <Text>
              Secret not found: <strong>{secretKey}</strong>
            </Text>
            <Text fontSize="sm">
              Please create this secret in project: <strong>{projectId}</strong>
            </Text>
            <Link href={consoleUrl} isExternal color="blue.500" fontSize="sm">
    ...
    if (error.includes('Request timed out')) {
      return (
        <VStack align="stretch" spacing={1}>
          ...
          <Text fontSize="sm">Please check your internet connection and try again.</Text>
        </VStack>
      );
    }
        ...
        <TabPanels>
                    ...
                    return (
                      ...
                      >
                        <VStack align="stretch" spacing={2}>
                          ...
                          {status.error && <Box>{formatErrorMessage(status.error)}</Box>}
                        </VStack>
                      </Box>
                    );
                  })}
          ...
          <TabPanel>
            <VStack spacing={4} align="stretch">
              ...
              <Button colorScheme="blue" onClick={handleCreateSecret} isLoading={loading}>
                Create Secret
              </Button>
            </VStack>
          </TabPanel>
